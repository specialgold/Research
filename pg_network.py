...
class PGLearner:
    def __init__(self, pa):
        ...
        self.network_compact_dim = pa.network_compact_dim
        ...
        # print 'network_compact_dim=', pa.network_compact_dim
    ...
    def choose_action_testing(self, state):
    ...
    def get_one_act_prob(self, state):
        ...
        states = np.zeros((1, 1, self.network_compact_dim), dtype=theano.config.floatX)
        # states[0, :, :] = state
        states[0, :] = state
